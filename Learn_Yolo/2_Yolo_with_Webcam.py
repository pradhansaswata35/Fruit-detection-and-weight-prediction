...
# '0' for use internal webcamp, and set '1' for use anoter external webcam
# cap = cv2.VideoCapture(0)  # for webcam
# cap.set(3, 680)  # '3' is propid number, it's used to set the width
# cap.set(4, 480)  # '4' is propid number, it's used to set the height
